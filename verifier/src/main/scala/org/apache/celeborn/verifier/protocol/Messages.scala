...
case class RegisterRunner(uid: String, resource: NodeStatus)
  extends Message
...
case class RunnerHeartBeat(uid: String, resource: NodeStatus, diff: NodeStatus)
  extends Message

case class SubmitPlan(plan: VerificationPlan)
  extends Message
...
case class ExecuteOperation(operation: Operation)
  extends Message
